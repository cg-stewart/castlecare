      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card className="border-lime-500">
          <CardHeader>
            ...
            <CardDescription>Unlock premium features and opportunities</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="mb-4">
          ...
          <CardFooter>
            <Button className="w-full bg-lime-500 hover:bg-lime-600 text-white">Become Preferred</Button>
          </CardFooter>
        </Card>
      </div>
    </div>
